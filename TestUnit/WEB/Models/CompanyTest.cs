...
namespace TestUnit.WEB.Models
{
	public class CompanyTest
	{
		...
		public void Entidad()
		{
			...
			datos.matriculaMercantil = "string";
			datos.idestado = 1;
			datos.estado = "string";

			var type = Assert.IsType<Entidad>(datos);
			Assert.NotNull(type);
		}
		...
		public void Novedad()
		{
			...
			file.tipoAdjunto = "string";

			List<Archivo> listfile = new List<Archivo>();
			listfile.Add(file);	

			Novedad datos = new Novedad();
			datos.codigo = 1;
			datos.codigoEmpresa = 1;
			...
			datos.idEstado = 1;
			datos.estado = "string";
			datos.idEstadoEmpresa = 1;
			datos.estadoEmpresa = "string";
			...
			datos.documentos = listfile;

			var type = Assert.IsType<Novedad>(datos);
			Assert.NotNull(type);
		}
