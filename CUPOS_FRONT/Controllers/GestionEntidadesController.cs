        ...
        public object GuardarNovedad(ReqNovedad datos)
        {
            try
            {
                ...
                var req = new
                {
                    ...
                    availableProductionBalance = datos.saldoProduccionDisponible ?? 0,
                    availableQuotas = datos.cuposDisponibles ?? 0,
                    availableInventory = datos.inventarioDisponible ?? 0,
                    pendingQuotasToProcess = datos.numeroCupospendientesportramitar ?? 0,
                    specimenDispositionId = datos.idDisposicionEspecimen,
                    zooCompanyId = datos.idEmpresaZoo ?? 0,
